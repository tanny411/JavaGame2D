...
public class Inventory {
	...
	private int invX,invY,invWidth, invHeight,invListCenterX,invListCenterY,invListSpacing ;
	...
	public Inventory(Handler handler){
		...
		inventoryItems = new ArrayList<Item>();
                ...
                invX = handler.getWidth()/2-512/2; invY = handler.getHeight()/2-384/2;
